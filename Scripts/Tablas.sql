...
CREATE TABLE GOALS_PREDICTION(
						Id INT IDENTITY(1,1) NOT NULL,
						Goal_Scorer INT NOT NULL,
						Attendee INT,
...
ALTER TABLE GOALS_PREDICTION
ADD CONSTRAINT GOAL_SCORER_FK FOREIGN KEY(Goal_Scorer)
REFERENCES PLAYER(Id),
CONSTRAINT ATTENDEE_FK FOREIGN KEY(Attendee)
REFERENCES PLAYER(Id),
CONSTRAINT PREDICTION_FK FOREIGN KEY(Id)
